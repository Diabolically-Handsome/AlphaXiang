#!/bin/bash
# v12.8 phase A: warm-start v12.6-micro and train only zero-init 2D relative bias.
...
OUT_DIR="${V128_OUT_DIR:-/home/laure/alphaxiang/training_runs/run_019a_v128_relbias_warmup}"
