#!/bin/bash
# Smoke-evaluate Pika d3/d4 for a v12.7 checkpoint on one GPU.
...
run_external "pika_d4" 4 127324
run_external "pika_d3" 3 127323
...
echo "v12.7 d3/d4 snapshot smoke DONE: $OUT_BASE"
