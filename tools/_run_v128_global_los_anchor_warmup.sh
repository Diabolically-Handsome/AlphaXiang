#!/bin/bash
# v12.8G: combine global strategic summary with zero-init line-of-sight
# attention bias.  Hypothesis: global tokens help d3/d4 strategic shape,
# while LOS bias helps d5 tactical stability.
...
OUT_DIR="${V128_OUT_DIR:-/home/laure/alphaxiang/training_runs/run_019h_v128_global_los_anchor}"
