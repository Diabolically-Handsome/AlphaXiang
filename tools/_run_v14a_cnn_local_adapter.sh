...
OUT="/home/laure/alphaxiang/training_runs/run_040a_v14a_cnn_local_adapter_from031a19000"

exec "$PY" -u xiangqi_train.py \
  --foreground \
  --model-preset v14a_200m_cnn_adapter \
  --resume-path "$BASE" \
  ...
  --selfplay-dir-sampling-ratios 0.70 0.10 0.05 0.05 0.05 0.05 \
  --device cuda:0 \
  ...
  --anchor-policy-kl-weight 2.0 \
  --anchor-value-mse-weight 0.5
