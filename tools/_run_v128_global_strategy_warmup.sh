#!/bin/bash
# v12.8 phase D: train a zero-init global strategic-attention adapter.
...
OUT_DIR="${V128_OUT_DIR:-/home/laure/alphaxiang/training_runs/run_019e_v128_global_strategy_warmup}"
